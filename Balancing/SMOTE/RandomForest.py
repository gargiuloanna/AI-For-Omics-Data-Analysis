...
# save model
save_estimator(rdf_gridcv.best_estimator_, "RF_SMOTE.joblib")
print("[RANDOM FOREST WITH SMOTE] RF_SMOTE model saved")

# predict
score = balanced_model_predict(model=rdf_gridcv.best_estimator_, name="RF_SMOTE", test_data=data_test, test_labels=labels_test)
