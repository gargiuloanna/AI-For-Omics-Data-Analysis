...
data_train, data_test, labels_train, labels_test = train_test_split(data_sc, labels_resampled_np, test_size=0.30,
...
# Load SVM_RFE
svm = load_estimator("SVM_RFE_SMOTE.joblib")
...
# Load Random Forest
rdf = load_estimator("RF_OVR_SMOTE.joblib")
# _____________________________________________________________________COMPARISON_____________________________________________________________________#
for i in range(0, 5):
